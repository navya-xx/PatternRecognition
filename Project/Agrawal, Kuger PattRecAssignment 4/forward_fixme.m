...
%--------------------------------------------------------
%Corrections made by Navneet Agrawal and Lars Kuger
%--------------------------------------------------------
% Rename this file to forward.m and copy it into your @MarkovChain folder
% Then run verify.m in order to test the function
