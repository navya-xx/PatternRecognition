...
%load 'TrainedHMM-2Wordlength2States-recTr12-002sec_ALL'% includes training for all
%load 'TrainedHMM-Wordlength2States-002secLars' % only one
%load 'TrainedHMM-2Wordlength2States-recTr12-002sec_navneet' % only one
load 'TrainedHMM-2Wordlength2States-recTr12-002sec_lars' % only one
